...
app.MapGet("/departamento/lista", async (
    ...
    IMapper _mapper) =>
    {
        var listaDepartamento = await _departamentoServicio.Lista();
...
app.MapGet("/empleado/lista", async (
    ...
    IMapper _mapper) =>
{
    var listaEmpleado = await _empleadoServicio.Lista();
    ...
    IMapper _mapper) =>
{
    ...
    var _empleadoCreado = await _empleadoServicio.Agregar(_empleado);
...
app.MapPut("/empleado/actualizar/{idEmpleado:int}", async (
    int idEmpleado,
    EmpleadoDTO modelo,
    IEmpleadoService _empleadoServicio,
    IMapper _mapper) =>
{
    var _encontrado = await _empleadoServicio.Obtener(idEmpleado);
    ...
    var respuesta = await _empleadoServicio.Editar(_encontrado);
...
app.MapDelete("/empleado/eliminar/{idEmpleado:int}", async (
    int idEmpleado,
    IEmpleadoService _empleadoServicio
    ) =>
{
    ...
    var respuesta = await _empleadoServicio.Eliminar(_encontrado);
